...
#define ADC_CHNM_ANA_INPUT      ADC_CHN_VDDEC  //others parameters (ADC_CHN_GP17 ADC_CHN_GP18 ADC_CHN_GP22 ADC_CHN_GP23)
...
#else					// firmware in otp(otp max size is (0x3fff - 80))
...
#define	CFG_TP_ORDER_ADDR_OTP			  0x3FE6	// 2bytes
#define	CFG_TP_ORDER_ADDR_FLASH			  0x76006	// 2bytes	if  otp is not written, read flash instead
...
#define	CFG_ADR_MAC_ADDR_FLASH			  0x76000	// 6bytes
...
#define	CFG_ADR_POWER_LEVEL               0x3FF1    // 2bytes
