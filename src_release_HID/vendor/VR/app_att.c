...
const u8    my_PnPtrs [] = {0x02, 0x12, 0x34, 0x56, 0x78, FW_VERSION_ID2, FW_VERSION_ID1};
...
***************************************************************************/
	   // gap, 5
		   ...
		   {0,2, 18, (u8*)(&my_devNameUUID),			(u8*)(tbl_adv+21)},		// (u8*)(tbl_adv+21), tbl_adv[19]-1
...
***************************************************************************/	  	
    ...
    {HID_CONTROL_POINT_DP_H-HID_PS_H+1,2,2,(u8*)(&my_primaryServiceUUID),    (u8*)(&my_hidServiceUUID)},

   //2,include battery service
   // {0,sizeof(include), GATT_UUID_INCLUDE,    (u8*)(include)},
	...
	{0,2,sizeof(reportRefMouseIn),(u8*)(&reportRefUUID), 	(u8*)(reportRefMouseIn)},
	 ...
	 // report in : 4 (char-val-client-ref), handle start from 0x19
		{0,2,1,(u8*)(&my_characterUUID),	  (u8*)(&PROP_READ_NOTIFY)},				//prop
		{0,2,sizeof(reportJoyStickIn),(u8*)(&hidReportUUID),   (u8*)(reportJoyStickIn)}, //value
		{0,2,sizeof(generalValInCCC),(u8*)(&clientCharacterCfgUUID),	(u8*)(generalValInCCC)},  //value
		{0,2,sizeof(reportRefJoyStickIn),(u8*)(&reportRefUUID), 	(u8*)(reportRefJoyStickIn)},  //value
	
#endif 


#if(KEYBOARD_REPORT_SUPPORT)   
	 // report out: 3 (char-val-ref)
		{0,2,1,(u8*)(&my_characterUUID),	  (u8*)(&PROP_READ_WRITE_WRITENORSP)},				 //prop
		{0,2,sizeof(reportKeyOut), (u8*)(&hidReportUUID),	  (u8*)(&reportKeyOut)},	//value
		{0,2,sizeof(reportRefKeyOut), (u8*)(&reportRefUUID),   (u8*)(reportRefKeyOut)}, //value
    ...
    //42
    // report map: 3
    {0,2,1,(u8*)(&my_characterUUID),      (u8*)(&PROP_READ)},              //prop
    {0,2,sizeof(reportMapAndroid),(u8*)(&hidReportMapUUID), (u8*)(reportMapAndroid)},   //value
   // {0,sizeof(extServiceUUID),GATT_UUID_EXT_REPORT_REF,  (u8*)(&extServiceUUID)}, //value
    //45
    // hid information: 2
    {0,2,1,(u8*)(&my_characterUUID),      (u8*)(&PROP_READ)},               //prop
    {0,2,sizeof(hidInformation),	(u8*)(&hidinformationUUID),    (u8*)(hidInformation)},  //value
    //47
    // control point: 2,
    {0,2,1,(u8*)(&my_characterUUID),      (u8*)(&PROP_WRITE_NORSP)},               //prop
    {0,2,sizeof(controlPoint),	(u8*)(&hidCtrlPointUUID),  (u8*)(&controlPoint)},   //value
/**************************************************************************
							Battery (Services)
***************************************************************************/
...
***************************************************************************/
	...
	{8,2,16, (u8*)(&my_primaryServiceUUID),	(u8*)(my_newGameServiceUUID)},

	{0,2,1, (u8*)(&my_characterUUID),	(u8*)(&PROP_READ_NOTIFY)},	  //prop
	{0,16,sizeof(my_newGameNotifyIn), (u8*)(my_newGameNotifyUUID),(u8*)(my_newGameNotifyIn)}, //value
	{0,2,2, (u8*)(&clientCharacterCfgUUID),    (u8*)(generalValInCCC)},  //value

	{0,2,1, (u8*)(&my_characterUUID),	(u8*)(&PROP_WRITE)},	  //prop
	{0,16,sizeof(my_newGameWriteCmdOut), (u8*)(my_newGameWriteCmdUUID),(u8*)(my_newGameWriteCmdOut)}, //value

	{0,2,1, (u8*)(&my_characterUUID),	(u8*)(&PROP_WRITE)},	  //prop
	{0,16,sizeof(my_newGameWriteDataOut), (u8*)(my_newGameWriteDataUUID),(u8*)(my_newGameWriteDataOut)}, //value
#endif
/**************************************************************************
							W24G (Services)
***************************************************************************/
#if(W24_MODE_SUPPORT)
	{4,2,2, (u8*)(&my_primaryServiceUUID), (u8*)(my_W24ServiceUUID)},

	{0,2,1, (u8*)(&my_characterUUID),	(u8*)(&PROP_READ_WRITE_NORSP_NOTIFY)},	  //prop
	{0,2,sizeof(my_W24NotifyIn), (u8*)(my_W24NotifyUUID),(u8*)(my_W24NotifyIn)}, //value
	{0,2,2, (u8*)(&clientCharacterCfgUUID),    (u8*)(generalValInCCC)},  //value
#endif
/**************************************************************************
							OTA (Services)
...
void    shutter_att_init ()
{
	...
	//blt_smp_set_pairing_type(1,0);
     ...
     blt_smp_func_init ();	///hid need smp
}
