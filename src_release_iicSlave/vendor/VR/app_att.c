...
const u16 userDescCfgUUID = GATT_UUID_CHAR_USER_DESC;
...
////////////////////////Private Service//////////////////////////////////
static const u16 FEE7_UUID = 0xfee7;
static const u16 FEE7_read_charUUID = 0x36f6;
static const u8  FEE7_read_prop = CHAR_PROP_READ | CHAR_PROP_NOTIFY;
//u16 Read_value[20] = {0x00};
u8 Read_value[20] = {0x00};
u8 Read_clientCCC[]={0x00};
u8 Read_userDescCCC[]={'R','e','a','d',};


static const u16 FEE7_write_charUUID = 0x36f5;
static const u8  FEE7_write_prop = CHAR_PROP_WRITE;
u8 Write_value[16] = {0x00};
u8 Write_clientCCC[]={0x00};
u8 Write_userDescCCC[]={'W','r','i','t','e'};
...
/**************************************************************************
		1		private(Services)
***************************************************************************/
	{9,2,2,(u8*)(&my_primaryServiceUUID),	(u8*)(&FEE7_UUID)},
	{0,2,1,(u8*)(&my_characterUUID), 		(u8*)(&FEE7_write_prop)},
	{0,2,16,(u8*)(&FEE7_write_charUUID),	(u8*)(&Write_value)},
	{0,2,2,(u8*)(&clientCharacterCfgUUID),    (u8*)(Write_clientCCC)},  //value
	{0,2,sizeof(Write_userDescCCC), (u8*)(&userDescCfgUUID),    (u8*)(Write_userDescCCC)},  //value

	{0,2,1,(u8*)(&my_characterUUID), 		(u8*)(&FEE7_read_prop)},
	{0,2,20,(u8*)(&FEE7_read_charUUID),	(u8*)(&Read_value)},
	{0,2,2,(u8*)(&clientCharacterCfgUUID),    (u8*)(Read_clientCCC)},  //value
	{0,2,4,(u8*)(&userDescCfgUUID),    (u8*)(Read_userDescCCC)},  //value
/**************************************************************************
